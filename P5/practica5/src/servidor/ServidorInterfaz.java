...
public interface ServidorInterfaz extends Remote {
    ...
    public void rexeitarSolicitude(String solicitante, String receptor) throws RemoteException;
    
    public void aceptarSolicitude(String solicitante, String receptor) throws RemoteException;
